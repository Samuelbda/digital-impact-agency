import { r as reactExports, V as jsxRuntimeExports, a1 as ClientOnly, a2 as React } from "./server-CUkWiBp8.js";
...
function SplineRobot() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "aria-hidden": true, className: "absolute inset-0 overflow-hidden pointer-events-none", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-1/2 top-1/2 pointer-events-auto", style: {
      width: "140vw",
      height: "180vh",
      transform: "translate(-50%, -25%)"
    }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ClientOnly, { fallback: null }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-0 right-0 w-44 h-14 bg-background" })
  ] });
}
...
const matheus = "/assets/matheus-ksivYm-k.png";
const gustavo = "/assets/gustavo-C0x7Yi9y.png";
const camila = "/assets/camila-C2PUOrLK.png";
const samuel = "/assets/samuel-dS7jpbtg.png";
const tulio = "/assets/tulio-w7yGVRxZ.png";
const team = [{
  name: "Samuel Lenício",
  role: "Desenvolvedor Full Stack",
  img: samuel
}, {
  name: "Gustavo Matioli",
  role: "Desenvolvedor Full Stack",
  img: gustavo
}, {
  ...
  name: "Túlio Mattos",
  role: "Tráfego Pago & Marketing Digital",
  img: tulio
}, {
  name: "Camila Carvalho",
  role: "Gestão & Administração",
  img: camila
}];
const services = [{
  icon: CodeXml,
...
function Index() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background text-foreground relative", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "fixed top-0 inset-x-0 z-50 backdrop-blur-xl bg-background/60 border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "mx-auto max-w-7xl px-6 h-16 flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "#top", className: "flex items-center gap-2 font-display font-bold text-lg", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-8 h-8 rounded-lg bg-gradient-primary shadow-glow grid place-items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "w-4 h-4 text-primary-foreground" }) }),
        "SC ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient", children: "Agency" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden md:flex items-center gap-8 text-sm text-muted-foreground", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#sobre", className: "hover:text-foreground transition", children: "Sobre" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#equipe", className: "hover:text-foreground transition", children: "Equipe" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#servicos", className: "hover:text-foreground transition", children: "Serviços" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#contato", className: "hover:text-foreground transition", children: "Contato" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { asChild: true, size: "sm", className: "bg-gradient-primary text-primary-foreground hover:opacity-90 shadow-glow", children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "https://wa.me/5533999285190", target: "_blank", rel: "noreferrer", children: "Fale conosco" }) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "top", className: "relative pt-16 min-h-screen flex items-center overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(SplineRobot, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 mx-auto max-w-7xl px-6 pt-16 pb-24 w-full pointer-events-none", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
        opacity: 0,
        y: 20
      }, animate: {
        opacity: 1,
        ...
        duration: 0.8
      }, className: "relative z-10 max-w-2xl pointer-events-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-2 px-3 py-1 rounded-full border border-border bg-card/70 backdrop-blur text-xs text-muted-foreground mb-6", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-5xl md:text-6xl lg:text-7xl font-bold leading-[1.05] [text-shadow:0_4px_30px_oklch(0.1_0.05_260/0.6)]", children: [
          "Transformando grandes ideias em",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient", children: "presença digital de impacto" }),
          "."
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-6 text-lg text-muted-foreground max-w-xl", children: "Soluções inteligentes em Tecnologia e Marketing Digital para escalar o seu negócio com agilidade, design de vanguarda e resultados mensuráveis." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 flex flex-wrap gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { asChild: true, size: "lg", className: "bg-gradient-primary text-primary-foreground shadow-glow hover:opacity-90", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "#contato", children: [
            "Começar agora ",
            /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "ml-2 w-4 h-4" })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { asChild: true, size: "lg", variant: "outline", className: "border-border bg-card/60 backdrop-blur hover:bg-card", children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#servicos", children: "Ver serviços" }) })
        ] })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-x-0 bottom-0 h-40 bg-gradient-to-b from-transparent to-background pointer-events-none" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "sobre", className: "py-28 relative", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-5xl px-6 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm uppercase tracking-[0.2em] text-primary mb-4", children: "A Agência" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-4xl md:text-5xl font-bold", children: [
        "Inovação tecnológica e marketing de ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient", children: "alta performance" }),
        "."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-6 text-lg text-muted-foreground max-w-3xl mx-auto", children: "Somos uma agência focada em impulsionar empresas com agilidade, resultados mensuráveis e design de vanguarda. Cada projeto é pensado para gerar autoridade, conversão e crescimento real." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-12 grid grid-cols-3 gap-6 max-w-2xl mx-auto", children: [{
        k: "+50",
        ...
        k: "100%",
        v: "Foco em resultado"
      }].map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-border bg-card/50 p-6 shadow-card", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "servicos", className: "py-28 bg-card/30 border-y border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm uppercase tracking-[0.2em] text-primary mb-4", children: "O que fazemos" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-4xl md:text-5xl font-bold", children: "Serviços de ponta a ponta." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-14 grid sm:grid-cols-2 lg:grid-cols-4 gap-5", children: services.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
        opacity: 0,
        y: 20
      }, whileInView: {
        opacity: 1,
        ...
        duration: 0.5,
        delay: i * 0.08
      }, className: "group rounded-2xl border border-border bg-background/60 p-7 shadow-card hover:border-primary/60 transition", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-xl bg-gradient-primary grid place-items-center shadow-glow mb-5 group-hover:scale-110 transition", children: /* @__PURE__ */ jsxRuntimeExports.jsx(s.icon, { className: "w-5 h-5 text-primary-foreground" }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "equipe", className: "py-28", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center max-w-2xl mx-auto mb-14", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm uppercase tracking-[0.2em] text-primary mb-4", children: "Meet the team" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-4xl md:text-5xl font-bold", children: "Pessoas por trás dos resultados." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-5 gap-5", children: team.map((m, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
        opacity: 0,
        y: 20
      }, whileInView: {
        opacity: 1,
        ...
        duration: 0.5,
        delay: i * 0.06
      }, className: "group rounded-2xl overflow-hidden border border-border bg-card shadow-card hover:shadow-glow transition", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-square overflow-hidden bg-muted", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: m.img, alt: m.name, className: "w-full h-full object-cover grayscale group-hover:grayscale-0 group-hover:scale-105 transition duration-500" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold", children: m.name }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: m.role })
        ] })
      ] }, m.name)) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { id: "contato", className: "py-24 relative overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-hero opacity-60" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mx-auto max-w-5xl px-6 text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-4xl md:text-6xl font-bold leading-tight", children: [
          ...
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient", children: "próxima era do seu negócio" }),
          "?"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-6 text-lg text-muted-foreground", children: "Vamos conversar sobre o seu próximo projeto." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-10 flex flex-wrap justify-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { asChild: true, size: "lg", className: "bg-gradient-primary text-primary-foreground shadow-glow hover:opacity-90", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "https://wa.me/5533999285190", target: "_blank", rel: "noreferrer", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(MessageCircle, { className: "mr-2 w-4 h-4" }),
            " WhatsApp (33) 99928-5190"
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { asChild: true, size: "lg", variant: "outline", className: "border-border bg-card/40", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "https://wa.me/5533999031690", target: "_blank", rel: "noreferrer", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(MessageCircle, { className: "mr-2 w-4 h-4" }),
            " WhatsApp (33) 99903-1690"
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { asChild: true, size: "lg", variant: "outline", className: "border-border bg-card/40", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "mailto:contato@scagency.com.br", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "mr-2 w-4 h-4" }),
            " E-mail"
          ] }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-16 pt-8 border-t border-border flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-muted-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            "© ",
            (/* @__PURE__ */ new Date()).getFullYear(),
            " SC Agency. Todos os direitos reservados."
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#", "aria-label": "Instagram", className: "hover:text-foreground transition", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Instagram, { className: "w-4 h-4" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#", "aria-label": "LinkedIn", className: "hover:text-foreground transition", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Linkedin, { className: "w-4 h-4" }) })
          ] })
        ] })
      ] })
    ] })
